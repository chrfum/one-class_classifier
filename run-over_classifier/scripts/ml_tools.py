...
def nested_cv_svm(X, random_seed, decomposition, log_filename, n_outer_folds=7, n_inner_folds=5, n_components=65, mod_selection_score=accuracy_score, positive_class=0):
    ...
    Esempio:
    >>> nested_cv_svm(X, random_seed=42, decomposition=PCA, log_filename='svm_nested_cv.log', n_outer_folds=5, n_inner_folds=3, n_components=50)
...
def nested_cv_lof(X, random_seed, decomposition, log_filename, n_outer_folds=7, n_inner_folds=5, n_components=65, mod_selection_score=accuracy_score, positive_class=0):
    ...
    Esempio:
    >>> nested_cv_svm(X, random_seed=42, decomposition=PCA, log_filename='lof_nested_cv.log', n_outer_folds=5, n_inner_folds=3, n_components=50)
...
def nested_cv_if(X, random_seed, decomposition, log_filename, n_outer_folds=7, n_inner_folds=5, n_components=65, mod_selection_score=accuracy_score, positive_class=0):
    ...
    Esempio:
    >>> nested_cv_svm(X, random_seed=42, decomposition=PCA, log_filename='if_nested_cv.log', n_outer_folds=5, n_inner_folds=3, n_components=50)
...
def nested_cv_mlp_svm(X, random_seed, log_filename, n_outer_folds=7, n_inner_folds=5, n_components=65, mod_selection_score=accuracy_score, positive_class=0):
    """
    Esegue la cross-validation annidata utilizzando OneClassSVM con diverse combinazioni di parametri e utilizzando la classe
    EncoderMLP per la riduzione della dimensionalità.
    ...
    Esempio:
    >>> nested_cv_svm(X, random_seed=42, log_filename='svm_nested_cv.log', n_outer_folds=5, n_inner_folds=3, n_components=50)
        ...
        for inner_cv_number, (trainval_idx, valid_idx) in enumerate(inner_cv.split(X_train, y_train)):
            for kernel in kernels:
                ...
                for params in param_combinations:
                    ...
                    encoder = EncoderMLP(hidden_layer_size=n_components, max_iter=50, random_state=random_seed, solver='sgd')
                    encoder.fit(X_train)
...
def nested_cv_mlp_lof(X, random_seed, log_filename, n_outer_folds=7, n_inner_folds=5, n_components=65, mod_selection_score=accuracy_score, positive_class=0):
    """
    Esegue la cross-validation annidata utilizzando LocalOutlierFactor con diverse combinazioni di parametri e utilizzando la classe 
    EncoderMLP per la riduzione della dimensionalità.
    ...
    Esempio:
    >>> nested_cv_svm(X, random_seed=42, log_filename='lof_nested_cv.log', n_outer_folds=5, n_inner_folds=3, n_components=50)
...
def nested_cv_mlp_if(X, random_seed, log_filename, n_outer_folds=7, n_inner_folds=5, n_components=65, mod_selection_score=accuracy_score, positive_class=0):
    """
    Esegue la cross-validation annidata utilizzando IsolationForest con diverse combinazioni di parametri e utilizzando la classe
    EncoderMLP per la riduzione della dimensionalità.
    ...
    Esempio:
    >>> nested_cv_svm(X, random_seed=42, log_filename='if_nested_cv.log', n_outer_folds=5, n_inner_folds=3, n_components=50)
